...
import { ArrowDownIcon, ArrowUpIcon, DollarSign, Percent, TrendingUp, TrendingDown, IndianRupeeIcon } from "lucide-react"
      ...
      <Card className="dashboard-card border-l-4 border-l-[#4caf50] dark:border-l-[#81c784]">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="rounded-full bg-[#4caf50]/10 dark:bg-[#81c784]/20 p-2">
            <IndianRupeeIcon className="h-4 w-4 text-[#4caf50] dark:text-[#81c784]" />
          </div>
        </CardHeader>
        <CardContent>
